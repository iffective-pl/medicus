...
import EditHeadersButton from "../EditHeadersButton";
...
export default function TabHeaders(props) {
  ...
  return (
    <TabPane tabId="2" className="mt-3 mb-3">
      <Row>
        <Col>
          <EditHeadersButton token={props.keycloak.token} load={loadHeaders} forceUpdate={() => setUpdate(!update)} headers={headers}/>
